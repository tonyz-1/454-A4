/* A basic raytracer
 *
 * You can move the viewpoint with the right mouse button, and zoom
 * with the middle mouse button.  With the mouse in the window, you
 * can press '?' to see the options.  CTRL-left mouse gives you a
 * zoomed view of the pixels.
 *
